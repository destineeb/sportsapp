...
class SportsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create sport" do
    assert_difference('Sport.count') do
      post sports_url, params: { sport: { sports_id: @sport.sports_id, sports_type: @sport.sports_type } }
    end
  ...
  test "should update sport" do
    patch sport_url(@sport), params: { sport: { sports_id: @sport.sports_id, sports_type: @sport.sports_type } }
