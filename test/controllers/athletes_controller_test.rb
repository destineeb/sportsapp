...
class AthletesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create athlete" do
    assert_difference('Athlete.count') do
      post athletes_url, params: { athlete: { athlete_name: @athlete.athlete_name, class_year: @athlete.class_year, gender: @athlete.gender, position: @athlete.position, sports_id: @athlete.sports_id, team_id: @athlete.team_id } }
    end
  ...
  test "should update athlete" do
    patch athlete_url(@athlete), params: { athlete: { athlete_name: @athlete.athlete_name, class_year: @athlete.class_year, gender: @athlete.gender, position: @athlete.position, sports_id: @athlete.sports_id, team_id: @athlete.team_id } }
