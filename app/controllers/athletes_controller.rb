class AthletesController < ApplicationController
  ...
  def destroy
    @athlete.destroy
    respond_to do |format|
      format.html { redirect_to athletes_url, notice: 'Athlete was successfully deleted.' }
  ...
  private
    ...
    def athlete_params
      params.require(:athlete).permit(:athlete_name, :gender, :class_year, :sports_id, :team_id, :position)
    end
end
